Created a program for a movie rental store to initialize contents of a movie inventory by genre, format a customer list, and then process a sequence of inventory, rental, and customer history commands.
